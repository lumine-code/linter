...
function validateLinter(linter) {
  ...
  if (linter && typeof linter === "object") {
    ...
    // Optional, so absent is the default — every editor, as it always was.
    if (linter.editors !== undefined && linter.editors !== "any" && linter.editors !== "center") {
      messages.push("Linter.editors must be either 'any' or 'center'");
    }
  } else {
